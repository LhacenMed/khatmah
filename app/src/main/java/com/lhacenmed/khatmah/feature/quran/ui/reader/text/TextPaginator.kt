...
/**
 * A single display page in the text reader.
 *
 * [pageNum]  — 1-based sequential page number (within this riwaya's pagination).
 ...
 *
 * [bismillahPre] — map of suraNum → whether a basmala precedes it. Defaults to the standard rule
 * (all surahs except 1 and 9) when a surah is absent.
 */
object TextPaginator {
    ...
    /** Estimated Unicode code units per rendered line. Calibrated for ~360 dp content width. */
