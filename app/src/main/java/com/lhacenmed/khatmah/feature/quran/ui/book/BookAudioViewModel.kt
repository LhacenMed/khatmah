...
/**
 * Retains the book reader's [BookAudioController] across configuration changes (e.g. rotation), so
 ...
 */
class BookAudioViewModel(app: Application) : AndroidViewModel(app) {
