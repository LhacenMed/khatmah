...
enum class CalcMethod(
     ...
     * Offsets tuned against the official published timetable (Nouakchott, June 2024), then folded
 ...
 * user's country code via [com.lhacenmed.khatmah.feature.prayer.data.CountryMethodMap]; stored values are preserved so
...
data class PrayerCalcSettings(
     ...
     * When [autoSettings] is true, method/juristic come from [com.lhacenmed.khatmah.feature.prayer.data.CountryMethodMap]
